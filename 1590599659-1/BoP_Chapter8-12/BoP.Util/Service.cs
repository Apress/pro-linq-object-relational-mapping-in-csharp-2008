...
namespace BoP.Util
{
	...
	internal class Service
	{
		...
		/// the service name used to lookup this service
		/// </param>
		/// 
		/// <param name="assemblyName">
		/// the assembly name to locate for this service
		/// </param>
		/// 
		/// <param name="className">
		/// the class to instantiate in the assembly given
		/// </param>
		/// 
		...
		/// 
		/// <param name="factory">
		/// the secondary service factory that will be used to lookup the service
		/// </param>
		/// 
