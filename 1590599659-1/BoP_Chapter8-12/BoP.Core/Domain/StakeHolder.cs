...
namespace BoP.Core.Domain
{
    ...
    /// company, or organization that is involved
    /// in the domain.
    /// </summary>
    [Serializable]
    public abstract class StakeHolder:BaseEntity<int>
    {
        ...
        /// <summary>
        /// Property exposing Roles as List<>
        /// used to get List of Roles and Set the internal
        /// collection
        /// </summary>
		...
		/// <summary>
		/// Every subclass of this class must provide a name.  Depending
		/// on the subclass, the way the name is constructed may be
		/// different.  Example:  A name of a person vs a company name
		/// </summary>
		/// 
		/// <returns>
